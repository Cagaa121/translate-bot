...
# async def to_en(call: types.CallbackQuery):
...
# async def to_en(call: types.CallbackQuery):
#   text = call.message.text
#   result = await translate_user(text, "uz")
#   btn = await choose_lang()
#   await call.message.edit_text(result, reply_markup=btn)


# @dp.callback_query_handler(text="lang_ru")
# async def to_uz(call: types.CallbackQuery):
#   text = call.message.text
#   result = await translate_user(text, "ru")
#   btn = await choose_lang()
#   await call.message.edit_text(result, reply_markup=btn)
